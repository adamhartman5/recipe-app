...
const App = () => {
	...
	const deleteFavoriteRecipe = async (recipe: Recipe) => {
		try {
			await api.deleteFavoriteRecipe(recipe);
						...
						return (
							<RecipeCard
								...
								onFavoriteButtonClick={
									isFavorite ? deleteFavoriteRecipe : addFavoriteRecipe
								}
				...
				<div>
					{favoriteRecipes.map((recipe) => (
						<RecipeCard
							recipe={recipe}
							onClick={() => setSelectedRecipe(recipe)}
							onFavoriteButtonClick={deleteFavoriteRecipe}
							isFavorite={true}
						/>
					))}
				</div>
